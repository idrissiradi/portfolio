...
export function Hero() {
  return (
    <section className="mx-auto max-w-[720px] px-6 pb-12 pt-6">
      <div className="mb-4 font-mono text-[13px] text-accent">Data Science &amp; ML Developer</div>
      ...
      <p className="mt-5 max-w-[560px] font-sans text-[17px] leading-relaxed text-foreground/85">
        Based in Marrakech, Morocco. I build end-to-end ML systems — data pipelines, model
        training, and containerized APIs that hold up outside a notebook. Background in
        full-stack development, now focused on machine learning, deep learning, NLP, and
        computer vision.
      </p>
